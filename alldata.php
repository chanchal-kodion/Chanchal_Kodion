...
<div class="container-fluid text-center">
  ...
  <table class="table">
    ...
    <a style=color:white; href='update.php?id=<?php echo $details['id'] ?>'>Update</a></button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger text-white" ><a class="modal-button" href='delete.php?id=<?php echo $details['id'] ?>'>Yes</a></button>
      </div>
    </div>
  </div>
</div>
